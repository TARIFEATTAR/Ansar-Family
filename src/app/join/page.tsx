 ...
 * 
 * Entry point for seekers, new Muslims, and born Muslims reconnecting.
...
export default function JoinPage() {
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 4:
        return true; // Support areas are optional
      case 5:
    ...
    <main className="min-h-screen flex flex-col bg-ansar-cream">
      ...
      <div className="flex-1 flex items-center justify-center px-6 md:px-12 py-12">
        <div className="w-full max-w-xl">
          {step === 1 && (
            <FormStep title="Personal Details" subtitle="Join the Ansar Family">
          ...
          {step === 3 && (
            <FormStep title="Location" subtitle="This helps us find your local community">
              <div className="space-y-5">
                <div>
          ...
          {step === 5 && (
            <FormStep title="What Happens Next" subtitle="Your Safety Net is Activating">
              <div className="space-y-6">
                <div className="bg-ansar-sage-50 rounded-lg p-6 space-y-4">
                  <p className="font-body text-sm text-ansar-gray mb-4">
                    By clicking submit, you are activating your Safety Net:
                  </p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="font-body font-medium text-ansar-charcoal">The Human Call</p>
                      <p className="font-body text-sm text-ansar-gray">An AF Team member will reach out within 48 hours to hear your story</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <span className="font-heading text-ansar-sage-600 text-lg">3.</span>
                    <div>
                      <p className="font-body font-medium text-ansar-charcoal">The Local Meetup</p>
                      <p className="font-body text-sm text-ansar-gray">We will connect you to a local Ansar for coffee and an invite to our next Monthly Dinner</p>
                    </div>
                  </div>
                </div>
    ...
    <main className="min-h-screen flex items-center justify-center px-6 bg-ansar-cream">
      ...
      >
        ...
        <p className="font-body text-ansar-gray mb-8">
          Your safety net is activating. We're so glad you're here. Someone from our team will reach out within 48 hours.
