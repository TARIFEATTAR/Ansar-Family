  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-ansar-cream">
      <div className="text-center max-w-md mx-auto px-6">
        ...
        <p className="font-body text-ansar-gray mb-6">
          Your account doesn't have access to a partner dashboard. If you believe 
        ...
        <div className="space-y-3">
          ...
          <Link 
            href="/partner" 
            className="text-ansar-sage-600 font-body hover:underline block"
          >
            Apply to become a Partner Hub →
          </Link>
        </div>
      </div>
    </main>
